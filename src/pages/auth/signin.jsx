...
const SignIn = () => {
  ...
  return (
    <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", minHeight: "100vh", backgroundColor: "#f4f6f8", padding: 2 }}>
      <Card sx={{ maxWidth: 400, width: "100%", boxShadow: 10, borderRadius: 2 }}>
        <CardContent>
          <Box sx={{ display: "flex", justifyContent: "center", marginBottom: 3 }}>
            <Avatar sx={{ bgcolor: "#153B60", width: 70, height: 70 }}>
              <Typography variant="h4" sx={{ color: "white" }}>R</Typography>
            </Avatar>
          </Box>
          ...
          <Box sx={{ display: "flex", justifyContent: "center", marginTop: 2 }}>
            <Button onClick={() => setOpenResetDialog(true)} sx={{ textTransform: "none", fontWeight: "bold" }}>
              Forgot Password?
            </Button>
          </Box>
        </CardContent>
      ...
      <Dialog open={openResetDialog} onClose={handleCloseResetDialog}>
        <DialogTitle>{resetStep === 1 ? "Request Password Reset" : "Set New Password"}</DialogTitle>
        <DialogContent>
          {resetStep === 1 ? (
            <>
        ...
        <DialogActions>
          ...
          >
            {resetLoading ? <CircularProgress size={24} /> : resetStep === 1 ? "Send Reset Link" : "Reset Password"}
          </Button>
        </DialogActions>
      </Dialog>
